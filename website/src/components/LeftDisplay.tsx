...
const Icons = {
  ...
  parameters:
    <svg className={`w-7 h-7`} viewBox="0 0 28 28">
      ...
      <path fill="currentColor" fillRule="evenodd" d="M11.268 6H2a1 1 0 0 1 0-2h9.268A1.99 1.99 0 0 0 11 5c0 .364.097.706.268 1Zm3.464 0H26a1 1 0 1 0 0-2H14.732c.17.294.268.636.268 1s-.097.706-.268 1ZM17.268 15H2a1 1 0 1 1 0-2h15.268A1.99 1.99 0 0 0 17 14c0 .364.097.706.268 1Zm3.464 0H26a1 1 0 1 0 0-2h-5.268c.17.294.268.636.268 1s-.097.706-.268 1ZM7.268 24H2a1 1 0 1 1 0-2h5.268A1.99 1.99 0 0 0 7 23c0 .364.097.706.268 1Zm3.464 0H26a1 1 0 1 0 0-2H10.732c.17.294.268.636.268 1s-.097.706-.268 1Z" clipRule="evenodd"/>
    </svg>,
  contact:
    <svg className={`w-7 h-7`} viewBox="0 0 28 28">
      <path fill="currentColor" fillRule="evenodd" d="M4 3h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H13.937a2 2 0 0 0-1.537.72l-2.632 3.158c-.599.719-1.768.295-1.768-.64V23a2 2 0 0 0-2-2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Zm2 4h16a1 1 0 1 1 0 2H6a1 1 0 0 1 0-2Zm0 4h16a1 1 0 1 1 0 2H6a1 1 0 1 1 0-2Zm0 4h10a1 1 0 1 1 0 2H6a1 1 0 1 1 0-2Z" clipRule="evenodd"/>
    </svg>,
  credits:
    <svg className={`w-7 h-7`} viewBox="0 0 28 28">
      <g fill="currentColor" clipPath="url(#clip0_2196_81)">
  ...
  github:
    <svg className={`w-5 h-4.5`} viewBox="0 0 20 18">
      <g clipPath="url(#clip0_2175_13)">
        <path fill="currentColor" fillRule="evenodd" d="M9.906 0C4.84 0 .746 4.125.746 9.228a9.22 9.22 0 0 0 6.263 8.755c.455.091.622-.199.622-.443 0-.214-.015-.948-.015-1.712-2.548.55-3.079-1.1-3.079-1.1-.41-1.07-1.016-1.344-1.016-1.344-.834-.565.06-.565.06-.565.926.06 1.411.947 1.411.947.82 1.405 2.138 1.008 2.67.764.075-.596.318-1.009.576-1.238-2.033-.214-4.17-1.008-4.17-4.553 0-1.008.363-1.833.94-2.475-.092-.229-.41-1.176.09-2.444 0 0 .774-.245 2.518.947a8.807 8.807 0 0 1 2.29-.306 8.81 8.81 0 0 1 2.29.306c1.744-1.192 2.517-.947 2.517-.947.501 1.268.182 2.215.091 2.444.592.642.94 1.467.94 2.475 0 3.545-2.138 4.324-4.185 4.553.334.29.622.84.622 1.711 0 1.238-.015 2.231-.015 2.537 0 .244.166.534.621.443a9.221 9.221 0 0 0 6.264-8.755C19.066 4.125 14.956 0 9.906 0Z" clipRule="evenodd"/>
      </g>
      <defs>
...
const Separator: React.FC = () => {
  ...
  return (
    <div className={`flex-shrink-0 ${styles.border.border} border-t-1 h-0.25 rounded-full`} />
  )
}
  ...
  return (
    <div className={`flex flex-col justify-center p-2`}>
      ...
      <div ref={ref} className={`transition-all overflow-hidden`}>
        {/* pt-2 is used here instead of gap-2 on the very first div so that the padding doesn't appear when the container's height is 0. */}
        <div className={`pt-2`}>
          {children}
        </div>
      </div>
...
const ParameterInfo: React.FC<{
  ...
  return (
    ...
    <div className={`group flex items-center w-4.5 h-4.5 justify-center rounded-full border-1 font-medium text-[0.875rem] select-none ${
      color ? color : styles.border.border
    }`}>
      ?
      <div className={`transition-all absolute flex flex-col items-center -translate-y-1/2 mb-8 pointer-events-none opacity-0 group-hover:opacity-100 z-1`}>
        <div className={`${styles.base.bg} ${styles.highlight.border} w-100 px-4 py-3 border-1 rounded-[0.25rem] text-sm z-1`}>
          {info}
        </div>
      </div>
    </div>
...
const Parameter: React.FC<{
  ...
  return (
    <div className={`flex flex-col gap-1.5`}>
      <div className={`flex flex-row text-[1.125rem] justify-between`}>
...
const ParameterSlider: React.FC<{
  ...
  const sliderSelected = useRef(false);
  ...
  useEffect(() => {
    const mouseup = () => {
      sliderSelected.current = false
      document.body.style.userSelect = ""
    }
    const mousemove = (e: MouseEvent) => {
      const slider = sliderRef.current
      const track = trackRef.current
      if (sliderSelected.current && slider !== null && track !== null) {
        ...
        <div ref={sliderRef} className={`absolute flex h-full items-center`} >
          ...
          <div className={`absolute flex items-center justify-center group right-0`} >
            ...
            <div
              ...
              onMouseDown={() => sliderSelected.current = true}
            />
          </div>
        </div>
      </div>
    ...
    <div ref={flexRef} className={`transition-all relative`}>
      <div ref={widthRef} className={`absolute flex flex-row w-100 h-full right-0`}>
        ...
        <div className={`relative overflow-visible`}>
          <div className={`flex flex-col w-full h-full p-4 rounded-[1rem] ${styles.base.bg} border-b-1 ${styles.border.border} ${styles.text.text} ${
            showLeftDisplay ? "overflow-y-auto" : "overflow-hidden"
          }`}>
            <SolverSelector />
                      ...
                      <div className={`flex flex-row gap-1 items-center`}>
                        ...
                        <ParameterInfo info={
                          <span className={`text-green-400`}>
                            ...
                            finding a solution before BFS because not <u>all</u> low-track
