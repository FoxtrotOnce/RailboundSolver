            ...
            <CardContent>
              <Alert variant="destructive" className="mb-3">
                <AlertDescription>
                  ...
                  ideal for nearly any level, so only change them if you know
                  what you are doing and it is absolutely necessary!
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-3">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top" className="max-w-xs">
                          <p>
                            ...
                            computation time. Only increase if you know a car
                            must loop more than{" "}
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top" className="max-w-xs">
                          <p>
                            ...
                            algorithm cuts that branch. Decoys often require
                            more loops than regular cars to reach their
                            destinations. Only increase if you know a decoy must
                            loop more than{" "}
                ...
                <div className="space-y-2 p-3 rounded-lg border bg-muted/30">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant={
                        hyperparameters.gen_type === "DFS"
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                      onClick={() =>
                        setHyperparams(undefined, undefined, "DFS")
                      }
                    ...
                    <Button
                      variant={
                        hyperparameters.gen_type === "BFS"
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                      onClick={() =>
                        setHyperparams(undefined, undefined, "BFS")
                      }
                      className="flex-1 h-8 text-xs"
                    >
                      BFS
