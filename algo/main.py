...
directions = {
    ...
    T.CAR_ENDING_TRACK_RIGHT: {D.LEFT: D.CRASH, D.RIGHT: D.UNKNOWN, D.DOWN: D.CRASH, D.UP: D.CRASH},
    T.CAR_ENDING_TRACK_LEFT: {D.LEFT: D.UNKNOWN, D.RIGHT: D.CRASH, D.DOWN: D.CRASH, D.UP: D.CRASH},
    T.CAR_ENDING_TRACK_DOWN: {D.LEFT: D.CRASH, D.RIGHT: D.CRASH, D.DOWN: D.UNKNOWN, D.UP: D.CRASH},
    T.CAR_ENDING_TRACK_UP: {D.LEFT: D.CRASH, D.RIGHT: D.CRASH, D.DOWN: D.CRASH, D.UP: D.UNKNOWN},
    ...
    T.NCAR_ENDING_TRACK_DOWN: {D.LEFT: D.CRASH, D.RIGHT: D.CRASH, D.DOWN: D.UNKNOWN, D.UP: D.CRASH},
    T.NCAR_ENDING_TRACK_UP: {D.LEFT: D.CRASH, D.RIGHT: D.CRASH, D.DOWN: D.CRASH, D.UP: D.UNKNOWN}
}
